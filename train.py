...
def main(args):
    ...
    # Try loading real dataset, fall back to synthetic demo
    try:
        ...
        logger.warning("Real dataset not found. Run: python download_data.py")
    ...
    dataloaders = {
        "train": DataLoader(train_ds, batch_size=args.batch_size, shuffle=True,  num_workers=0, pin_memory=False),
        "val":   DataLoader(val_ds,   batch_size=args.batch_size, shuffle=False, num_workers=0, pin_memory=False),
        "test":  DataLoader(test_ds,  batch_size=args.batch_size, shuffle=False, num_workers=0, pin_memory=False),
    }
