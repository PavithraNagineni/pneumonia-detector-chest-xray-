...
def main(args):
    ...
    dataloaders = {
        "train": DataLoader(train_ds, batch_size=args.batch_size, shuffle=True,  num_workers=2),
        "val":   DataLoader(val_ds,   batch_size=args.batch_size, shuffle=False, num_workers=2),
        "test":  DataLoader(test_ds,  batch_size=args.batch_size, shuffle=False, num_workers=2),
    }
